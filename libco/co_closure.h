...
#define co_ref(name, ...)                                                                                             \
    repeat(comac_argc(__VA_ARGS__), decl_typeof, __VA_ARGS__) class type_##name {                                     \
    public:                                                                                                           \
        repeat(comac_argc(__VA_ARGS__), impl_typeof, __VA_ARGS__) int _member_cnt;                                    \
        type_##name(repeat(comac_argc(__VA_ARGS__), con_param_typeof, __VA_ARGS__)...)                                \
...
#define co_func(name, ...)                                                                                            \
    repeat(comac_argc(__VA_ARGS__), decl_typeof, __VA_ARGS__) class name : public stCoClosure_t {                     \
    public:                                                                                                           \
        repeat(comac_argc(__VA_ARGS__), impl_typeof_cpy, __VA_ARGS__) int _member_cnt;                                \
                                                                                                                      \
    public:                                                                                                           \
